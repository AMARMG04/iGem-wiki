...
const CardSection = () => {
  ...
  return (
    <>
      <section ref={textRef} className="text-center mb-12 text-8xl text-black-700 bg-pink-500">
        <p className="text-xxl font-bold">impactful facts related to</p>
        <p className="text-xxl font-bold">microplastics</p>
      </section>
