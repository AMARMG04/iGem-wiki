        ...
        <div className="">
          {references.map((ref, index) => (
            <a href={ref.link} target="_blank">
              <div
                key={index}
                className="border-b pb-4 last:border-b-0 p-4 space-y-4 hover:bg-indigo-700 hover:text-white"
              >
                <h3 className="font-nohemi_m text-2xl">
                  {ref.title} {ref.year}
                </h3>
                <p className="text-md font-inter font-medium">{ref.authors}</p>
