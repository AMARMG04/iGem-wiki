        ...
        <div ref={sectionRef} className="scroll-section-inner pt-14 ">
          {
            ...
            <div className="w-full mt-5 pt-11 " data-aos="zoom-out">
              ...
              <h2 className="text-[54px] mb-3 font-semibold text-white">{member.name}</h2>
              <div className="flex">
              <h3 className="text-white font-medium mb-4">{member.role} |</h3>
               <a href="hhttps://www.linkedin.com/" className=" flex items-center justify-center text-white pb-4"><img src={LinkedIn} className="w-4 mx-2" alt=""/>LinkedIn</a>
              </div>
