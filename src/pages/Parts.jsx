            ...
            <div className='grid grid-cols-3 gap-4 '>
                ...
                <div className='col-span-2 shadow-[0_5px_60px_-23px_rgba(0,0,0,0.3)] border p-6 rounded-lg'>
                    <div className='mb-10  flex flex-col' id='table1'>
                        ...
                        <div>
                            <h2>
                                Vilnius-Lithuania iGEM 2023 team's goal is to employ synthetic biology tools to modify naturally produced Komagataeibacter xylinus bacterial cellulose polymer composition.

                                Firstly, we chose to produce a cellulose-chitin polymer that would later be deacetylated, creating bacterial cellulose-chitosan (parts: BBa_K4719013, BBa_K4719014, BBa_K4719019, BBa_K4719020). This polymer is an easily modifiable platform (part: BBa_K4719024) compared to bacterial cellulose, with biomedicine and molecular biology applications. As a second approach, we designed indigo-dyed cellulose that could be used as a green chemistry way to apply cellulose in the textile industry (part: BBa_K4719018). Lastly, we have achieved a bioplastic composite of bacterial cellulose and polyhydroxybutyrate (PHB) synthesized by K. xylinus (part: BBa_K4719017).

                                We designed parts to combine separate production steps to optimize the polymers' manufacturing process. (Parts: BBa_K4719027, BBa_K4719028).

                                This collection is meant to be used for obtaining a polymer of the user’s choice, whether that would be bacterial cellulose-chitosan, bacterial cellulose-PHB, or in situ dyed cellulose. What is more, by designing these constructs, we demonstrated a collection of of synthetic biology tools for K. xylinus, which could be applied to create various combinations of biopolymer and bacterial cellulose composites.
                            </h2>
                            <ol className='mt-3 list-disc ml-5'>
                                <li> <a href="" className='text-orange-800'>BBa_K4719013</a> - Incorporation of N-acetylglucosamine into bacterial cellulose.</li>
                                <li><a href="" className='text-orange-800'>BBa_K4719013</a> - Incorporation of N-acetylglucosamine into bacterial cellulose.</li>
                                <li><a href="" className='text-orange-800'>BBa_K4719013</a> - Incorporation of N-acetylglucosamine into bacterial cellulose.</li>
                                <li><a href="" className='text-orange-800'>BBa_K4719013</a> - Incorporation of N-acetylglucosamine into bacterial cellulose.</li>
                                <li><a href="" className='text-orange-800'>BBa_K4719013</a> - Incorporation of N-acetylglucosamine into bacterial cellulose.</li>
