  ...
  return (
    <div className="bg-black h-fit relative xl:mt-4">
      <div className="text-black z-20 lg:h-[80%] xl:h-[100vh] relative">
        <div className="flex justify-center items-center">
          ...
          <div className="absolute lg:top-[85px] xl:top-[100px]" ref={worldRef}>
            <img
              src={World}
              alt="World"
              className=" xl:w-[495px]  h-auto  "
            />
            <img src={Plastic4} alt="" className="absolute right-0 bottom-[0px] w-36 animate-float" />
            <img src={Plastic2} alt="" className="absolute left-0 bottom-[0px] w-44 animate-float" />


            <img src={Plastic3} alt="" className="absolute right-[-40px] bottom-[300px] w-32 animate-float" />

            <img src={Plastic2} alt="" className="absolute left-0 top-[0px] w-44 animate-float" />
            <img src={Plastic1} alt="" className="absolute left-[-90px] top-[150px] w-52 animate-float" />
            <img src={Plastic1} alt="" className="absolute right-[50px] top-[-30px] w-52 animate-float" />
        ...
        <div className="absolute left-36 xl:left-40 top-[350px] xl:top-[390px] p-4 py-6 rounded-[13px] bg-violet-800 border-2 border-[#9d57f7]/[0.47] text-white"
          style={{
            boxShadow:
