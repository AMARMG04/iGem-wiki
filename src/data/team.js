export const team_members = [
  {
    name: "Eniyaa A M",
    role: "Wet Lab",
    image: "/src/assets/Images/Eniya.png",
    description:
  ...
  },
  {
    name: "Jeevananthan M",
    role: "Research",
    image: "/src/assets/Images/Jeevananthan.png",
    description:"Jeevananthan.M , a guy who is expanding his career in molecular and cancer biology as a researcher with a strong grasp of theoretical and practical applications. Adaptable to any situation, he excels in research and development (R&D) and wet lab. Beyond the lab coat, he is a content writer, photographer, social worker, guitarist, avid music listener , and his favorite artist is Abel, known as “The Weeknd”. He believes in the saying, \"Nothing happens until something moves\".", 

  },
  {
    name: "Lokaveenasri D",
    role: "Dry Lab",
    image: "/src/assets/Images/Lokaveenasri.png",
    description:"Get  ready to meet Lokaaaaa – the epitome of zest, zeal, and zing! Every moment spent with her is an electrifying experience, whether she's embarking on a Netflix odyssey, flying to new horizons, or deepening her knowledge with courses. From crafting captivating melodies on her keyboard to unraveling the mysteries of programming and biotech, she is a perpetual dynamo of creativity and innovation. But that's not all – she is also a culinary adventurer, cooking and savoring delicious dishes in different places, always eager to taste life's diverse flavors. With a knack for seizing opportunities and a sociable spirit that thrives among people, she is fiercely passionate about building innovative solutions and pushing boundaries in the tech world as a woman in tech. From cooking up code to savoring life's diverse flavors, join her on this exhilarating rollercoaster of discovery, laughter, and endless happiness – it's going to be an epic ride!", 

  },
  {
    name: "Kamakshi B",
    role: "Research",
    image: "/src/assets/Images/Kamakshi.png",
    description:"Introducing Kamakshi: a powerhouse of ambition, energy, and unwavering determination.  As a social butterfly, she thrives on connecting with people and delving into their stories, finding joy in every interaction. From immersing herself in gripping crime thrillers to embarking on culinary adventures, she embraces life with boundless enthusiasm and optimism. Spreading love and solving problems are not just passions – they're her purpose. With a heart that finds healing in caring for others and a deep love for animals, she is fueled by compassion and driven to make a difference. In the realm of science, she is unstoppable – conducting meticulous research, working tirelessly in the wet lab, and relentlessly pursuing innovation. Join her on this extraordinary journey of discovery, empowerment, and making waves in the world of life sciences.", 

  },
  {
    name: "Keerthika S",
    role: "Dry Lab",
    image: "/src/assets/Images/Keerthika.png",
    description:"Meet KEERTHIKA S: An ambitious and dedicated individual, she channels her drive into a profound passion for science, especially genetics and molecular biology🧬. Balancing her dynamic nature, she revels in the world of literature, finding tranquility within its pages and the strokes of her paintbrush , exploring her creativity. With a foundation in classical dance since age 9 , her inquisitive nature propels her to continuously seek knowledge and excel in her multifaceted pursuits. She loves immersing herself in laboratory work , brimming with boundless enthusiasm and happiness , showcasing her exceptional dedication. A beacon of optimism and confidence, Keerthika thrives as a problem solver , always seeking solutions to any challenge that comes her way!", 
  ...
  },
  {
    ...
    role: "Wet Lab",
    image: "/src/assets/Images/Jothimurugan.png",
  ...
  },
  {
    name: "Jeothilashmi A",
    role: "Dry Lab Lead",
    image: "/src/assets/Images/Jeothilakshmi.png",
  ...
  },
  {
    name: "Ajay Karthik M",
    role: "Wet Lab",
    image: "/src/assets/Images/Ajay.png",
  ...
  },
  {
    name: "Kadhiravan S",
    role: "Dry Lab Lead",
    image: "/src/assets/Images/Kadhiravan.png",
